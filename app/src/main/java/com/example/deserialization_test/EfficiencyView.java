...
public class EfficiencyView extends View {
    private static final float MIN_VALUE = 0.0f; // Minimum value
    private static final float MAX_VALUE = 40.0f; // Maximum value
    ...
    public EfficiencyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw title
        canvas.drawText("Efficiency", width / 2 - 100, 50, textPaint);
